...
<body>
    <header class="z-[1000] fixed w-full bg-white transition-colors duration-300 shadow-md">
        <nav class="py-[10px] lg:py-[15px]" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div class="container-full flex items-center justify-between">
                ...
                <!--<div id="menu" class="hidden xl:flex gap-6 text-black">
                ...
                <?php
                    wp_nav_menu( array(
                        ...
                        'container_class'   => 'hidden xl:flex gap-6 !text-black', // Clases del contenedor
                        ...
                        'items_wrap'        => '%3$s',            // Esto elimina el <ul> envolvente
                    ) );
                ?>
                <div class="flex items-center text-black gap-4 language">
                    <button
                        class="lang-btn border-[#CCC] hover:border-black transition duration-300 ease-in-out border-[1px] rounded-full w-[40px] h-[40px] lg:w-[46px] lg:h-[46px] items-center flex justify-center cursor-pointer">
                        ES
                    </button>
                    <button
                        class="lang-btn border-[#CCC] hover:border-black border-[1px] transition duration-300 ease-in-out rounded-full w-[40px] h-[40px] lg:w-[46px] lg:h-[46px] items-center flex justify-center cursor-pointer">
                        EN
                    </button>
                    <div class="hidden md:flex">
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="36" viewBox="0 0 35 36"
                                fill="none" class="cursor-pointer transition duration-300 ease-in-out group">
                                <path
                                    ...
                                    fill="black" class="fill-black group-hover:fill-primaryBlue" />
                                <path
                    ...
                    <div class="w-[30px] h-[20px] flex xl:hidden justify-start items-center">
                        <div class="relative w-full h-full">
                            ...
                            <label for="btn_menu" class="btn_menu z-30 cursor-pointer flex flex-col w-auto h-full">
                                <span id="btn_span_1" class="btn_span !bg-black"></span>
                                <span id="btn_span_2" class="btn_span !bg-black"></span>
                                <span id="btn_span_3" class="btn_span !bg-black"></span>
                            </label>
                        </div>
                    </div>
                </div>
