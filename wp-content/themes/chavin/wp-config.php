...
define( 'WPCACHEHOME', '/home/c2700280/public_html/wp-content/plugins/wp-super-cache/' );
$sDestDir = '/home/c2700280/public_html';
if ( substr($sDestDir, 0, 1) == "\\" ) {
      $sDestDir = "\\".$sDestDir ;
}

/** El nombre de tu base de datos de WordPress */
define('DB_NAME', 'c2700280_wordpre');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'c2700280_wordpre');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'cumrwehlskuq0Xn');
...
//@ini_set('display_errors', 0); // Asegúrate de que PHP no muestre errores.
